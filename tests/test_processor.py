...
class TestConvertToDisplayAmount:
    ...
    def test_convert_jpy_amount(self):
        """JPY is a zero-decimal currency; amounts should not be divided by 100."""
        assert convert_to_display_amount(15800, "JPY") == 15800.0

    def test_convert_krw_amount(self):
        """KRW is a zero-decimal currency; amounts should not be divided by 100."""
        assert convert_to_display_amount(50000, "KRW") == 50000.0

    def test_convert_vnd_amount(self):
        """VND is a zero-decimal currency; amounts should not be divided by 100."""
        assert convert_to_display_amount(350000, "VND") == 350000.0
...
class TestProcessOrderPayment:
    ...
    def test_process_jpy_order(self, jpy_order_event_data: OrderEventData):
        """JPY order should be processed successfully without dividing by 100."""
