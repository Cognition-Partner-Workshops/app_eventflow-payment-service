...
# Currencies whose smallest unit is the base unit
...
def convert_to_display_amount(amount_minor: int, currency: str) -> float:
    ...
    Zero-decimal currencies such as JPY and KRW are already represented
    in the base unit and do not require conversion.
    """
