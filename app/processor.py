...
Zero-decimal currencies (JPY, KRW, VND, etc.) are handled correctly by
skipping the division by 100, since their minor unit equals the base unit.
"""
...
# These currencies should NOT be divided by 100 during conversion.
...
def convert_to_display_amount(amount_minor: int, currency: str) -> float:
    ...
    Returns:
        ...
        For zero-decimal currencies (JPY, KRW, VND, etc.) the amount
        is returned as-is because the minor unit equals the base unit.
    """
